...
public class Driver {
    ...
    public static void initializeDogList() {
        ...
        // Enhancement category 2 change:
        // Added dogs by using one shared method so the program keeps both the
        // dog list and the shared animal list consistent.
        addAnimal(dog1);
        addAnimal(dog2);
        addAnimal(dog3);
    }
    ...
    public static void initializeMonkeyList() {
        ...
        // Enhancement category 2 change:
        // Added monkeys by using one shared method so the program keeps both the
        // monkey list and the shared animal list consistent.
        addAnimal(monkey1);
    ...
    public static void intakeNewDog(Scanner scanner) {
        ...
        // Enhancement category 2 change:
        // Added the new dog through one shared method so it is saved in the
	...
	// to make sure the monkey doesn't already exist and the species type is allowed
        public static void intakeNewMonkey(Scanner scanner) {
            ...
            // Enhancement category 2 change:
            // Added the new monkey through one shared method so it is saved in the
            // correct data structures.
            addAnimal(newMonkey);
        ...
        public static void reserveAnimal(Scanner scanner) {
            ...
            if (animalType.equals("dog") || animalType.equals("monkey")) {
                ...
                if (availableAnimal != null) {
                    availableAnimal.setReserved(true);
